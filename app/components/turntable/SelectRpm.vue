...
<template>
	...
	>
		<span
			class="absolute left-1.25 text-[6px] leading-none font-medium text-[#33312d] select-none [text-shadow:0_1px_0_rgba(255,255,255,0.65)]"
		>
			{{ speed }}
		</span>
		...
		<!-- Indicator light -->
		<div
			class="absolute top-1/2 right-1.25 h-1.5 w-2 -translate-y-1/2 rounded-[1px] border border-red-950/50"
			:class="
				isActive
