...
SELECT lives_ok(
	$$
		...
		VALUES (
			...
			'[]'::JSONB,
			'[]'::JSONB,
			'00000000-0000-0000-0000-000000000301/00000000-0000-0000-0000-000000000311/10000000-0000-4000-8000-000000000001.webp'
		)
	$$,
...
SELECT lives_ok(
	$$
		...
		SET cover_storage_path = '00000000-0000-0000-0000-000000000301/00000000-0000-0000-0000-000000000311/10000000-0000-4000-8000-000000000002.webp'
...
SELECT is(
	...
	'00000000-0000-0000-0000-000000000301/00000000-0000-0000-0000-000000000311/10000000-0000-4000-8000-000000000002.webp',
...
SELECT ok(
	EXISTS (
		...
		WHERE object_path = '00000000-0000-0000-0000-000000000301/00000000-0000-0000-0000-000000000311/10000000-0000-4000-8000-000000000001.webp'
	),
...
SELECT throws_ok(
	$$
		UPDATE public.records
		SET cover_storage_path = '00000000-0000-0000-0000-000000000301/00000000-0000-0000-0000-000000000311/10000000-0000-4000-8000-000000000001.webp'
		WHERE id = '00000000-0000-0000-0000-000000000311'
	$$,
	'23514',
...
SELECT lives_ok(
	$$
		UPDATE public.records
		SET cover_storage_path = '00000000-0000-0000-0000-000000000301/00000000-0000-0000-0000-000000000311/10000000-0000-4000-8000-000000000003.webp'
		WHERE id = '00000000-0000-0000-0000-000000000311'
	$$,
...
VALUES (
	...
	'[]'::JSONB,
	'[]'::JSONB,
	'00000000-0000-0000-0000-000000000302/00000000-0000-0000-0000-000000000313/10000000-0000-4000-8000-000000000004.webp'
);
SELECT lives_ok(
	$$
...
SELECT ok(
	...
	AND EXISTS (
		SELECT 1
		FROM public.record_cover_cleanup_jobs
		WHERE object_path = '00000000-0000-0000-0000-000000000302/00000000-0000-0000-0000-000000000313/10000000-0000-4000-8000-000000000004.webp'
	),
